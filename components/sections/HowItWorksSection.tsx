...
const features = [
  {
    ...
    Icon: () => (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600" aria-hidden="true">
...
export default function HowItWorksSection() {
  return (
    <section 
      ...
      aria-label="Why choose PhysicsLab"
    >
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-[45px] h-[45px] rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center mb-6" aria-hidden="true">
                <feature.Icon />
              </div>
              <h3 
